...
volatile int virtualEncoderCount = 0; //updated by the interrupt service routine (ISR)****
int lastCount = 0; //***
volatile float virtualShaftPosition = theta0; //***
const int bouncedt = 925; //microseconds***
